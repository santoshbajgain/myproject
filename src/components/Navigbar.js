...
export default function Navigbar(props) {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link" to="/about">{props.details}</Link>
        </li>
        <li className="nav-item">
          <Link className="nav-link" to="/contact">{props.cntDetails}</Link>
        </li>
  ...
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault"> {props.btnSwitch} </label>
</div>
    </div>
  </div>
</nav>
